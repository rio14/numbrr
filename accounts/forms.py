...
class ChangeProfileForm(forms.Form):
    ...
    branch = forms.CharField(label=_('Add Branch'),
                            widget=forms.TextInput(attrs={'placeholder': 'Add Branch like for e.g- DD nagar, Dangania, Sundar Nagar etc'}), required=True)

class ChangeProfileForm2(forms.Form):
    mobile = forms.IntegerField(label=_('Mobile No'), required=True)
    SenderID = forms.CharField(label=_('SenderID'),required=True)
    branch = forms.CharField(label=_('Add Branch'),
                            widget=forms.TextInput(attrs={'placeholder': 'Add Branch like for e.g- DD nagar, Dangania, Sundar Nagar etc'}), required=True)
